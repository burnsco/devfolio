export const projectCategories = [
	{
		...
		projects: [
			...
			},
			{
				...
				description:
					"Full-stack Twitch/Discord-style app with a high-performance Zig backend and Next.js frontend, supporting real-time chat and HLS streaming.",
	...
	},
	{
		...
		projects: [
			...
			},
			{
				...
				description:
					"Real-time online poker platform featuring a Phoenix-powered backend for table state and a sleek React frontend for immersive gameplay.",
			...
			},
			{
				...
				color: "#3b82f6",
				tech: "Astro 5 · Three.js · TypeScript · Cloudflare Pages",
				description:
